...
<img src="assets/banner.svg" alt="Robot Race On Line" width="100%"/>

# 🏎️ Robot Race on Line
...
Репозиторий содержит полный исходный код прошивки и 3D-модели скоростного робота для соревнований по регламенту **«Гонка по линии»** (Line Follower / Robot Race).
...
- 💻 **Инженерный симулятор компоновки ([robot-race-sim](https://github.com/hegoleg/robot-race-sim))**:
  - Интерактивное React + Electron приложение для подбора идеальной базы, диаметра и ширины колес, оборотов мотора, питания и тестирования реального кода Arduino / C++ до сборки робота в железе (вынесено в отдельный репозиторий [hegoleg/robot-race-sim](https://github.com/hegoleg/robot-race-sim)).
...
## 💻 Инженерный симулятор робота ([robot-race-sim](https://github.com/hegoleg/robot-race-sim))

Симулятор физики и алгоритмов гоночного робота вынесен в отдельный специализированный репозиторий:  
...
- 🎮 **Кнопки управления и запуск (BOOT)**: интерактивная кнопка старта на роботе и в UI, горячая клавиша `Пробел`, звуковые эффекты.
